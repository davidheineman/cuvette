...
QUOTES = [
    ...
    "Although this wave of popularity is certainly pleasant and exciting for those of us working in the field, it carries at the same time an element of danger... It will be all too easy for our somewhat artificial prosperity to collapse overnight when it is realized that the use of a few exciting words like information, entropy, redundancy, do not solve all our problems (Shannon on the popularity of information theory, 1956).", # https://aclanthology.org/J10-4001
    "It is fair to assume that neither [(1) “Colorless green ideas sleep furiously”] nor [(2) “Furiously sleep ideas green colorless”] (nor indeed any part of these sentences) has ever occurred in an English discourse. Hence, in any statistical model for grammaticalness, these sentences will be ruled out on identical grounds as equally 'remote' from English. Yet (1), though nonsensical, is grammatical, while (2) is not (Ye olde spicy opinion, 1957).", # https://aclanthology.org/J10-4001
]
